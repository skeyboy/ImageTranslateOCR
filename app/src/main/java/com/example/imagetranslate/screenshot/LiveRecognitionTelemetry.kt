...
internal object LiveRecognitionTelemetry {
    ...
    fun completion(
        ...
        .put("raw_recognized", metrics.rawRecognizedCount)
        .put("edge_filtered", metrics.edgeFilteredCount)
        .put("edge_recovered", metrics.edgeRecoveredCount)
        .put("continuations", metrics.continuationCount)
